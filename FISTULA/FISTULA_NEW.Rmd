...
*The project's goal is to identify whether unique responses occur for fistulas that successfully mature and/or those that don’t,* by investigating on inter-correlations among time-changes in fistula morphology, hemodynamics, gene expression, and smooth muscle cell and endothelial cell dysfunctions. 
...
***By investigating the genomics of all patients which fistula failied or shown anatomic/hemodynamic signatures of failure risks, we are able to obtain a list of genes potenitally involved with fistula failure mechanicsms.***
...
[ML Robbin et al. Arteriovenous fistula development in the first 6 weeks after creation. Radiology 2016; 279:620–629](https://pubs.rsna.org/doi/pdf/10.1148/radiol.2015150385)  

[Y He et al. Serial analysis of lumen geometry and hemodynamics in human arteriovenous fistula for hemodialysis using magnetic resonance imaging and computational fluid dynamics. J Biomech. 2013; 46:165–169.](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4120947/pdf/nihms419674.pdf)
