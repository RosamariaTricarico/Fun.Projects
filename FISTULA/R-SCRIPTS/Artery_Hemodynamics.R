...
pdf(file="AllPatients_artery_Area.pdf")
...
pdf(file="AllPatients_artery_WSSave.pdf")
...
pdf(file="AllPatients_artery_WSSmax.pdf")
...
pdf(file="AllPatients_artery_WSSGave.pdf")
...
pdf(file="AllPatients_artery_OSI.pdf")
